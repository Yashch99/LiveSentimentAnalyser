...
word_features_f = open("pickledalgos/word_features.pickle","wb")
...
featuresets_f = open("pickledalgos/featuresets.pickle","wb")
...
MNB_classifier_f = open("pickledalgos/MNB_classifier.pickle","wb")
...
BernoulliNB_classifier_f = open("pickledalgos/BernoulliNB_classifier.pickle","wb")
...
LogisticRegression_classifier_f = open("pickledalgos/LogisticRegression_classifier.pickle","wb")
...
SGDClassifier_classifier_f = open("pickledalgos/SGDClassifier_classifier.pickle","wb")
...
LinearSVC_classifier_f = open("pickledalgos/LinearSVC_classifier.pickle","wb")
...
NuSVC_classifier_f = open("pickledalgos/NuSVC_classifier.pickle","wb")
